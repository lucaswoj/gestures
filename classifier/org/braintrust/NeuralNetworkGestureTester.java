...
public class NeuralNetworkGestureTester {
	...
	public static void main(String[] args) {
            ...
            for (int i = 0; i < 10; i++) {
                Tuple<double[], Integer> data = gestureStore.getRandomTrainingData(GestureStore.Gesture.CIRCLE);
                double[] input = data.x;
                n.train(data.x, new double[]{1});
            }
            
            for (int i = 0; i < 10; i++) {
                Tuple<double[], Integer> data = gestureStore.getRandomTestData(GestureStore.Gesture.CIRCLE);
